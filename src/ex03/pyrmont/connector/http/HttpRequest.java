 ...
 * @author flyingzc
 * 表示Http请求的类
 * 目前 该类中很多方法都是空方法(之后实现),但是已经可以获取 请求头,cookie 和 请求参数
 */
public class HttpRequest implements HttpServletRequest
{
     ...
     * 解析 请求参数,在servlet真正需要时才会调用
     */
    protected void parseParameters()
    {
        if (parsed)
            return;
        // ParamterMap继承自HashMap
        ...
        // 当请求头中的"content-length"值大于0,
        //"content-type"值为"application/x-www-form-urlencoded"则为post请求,需要解析请求体
